...
urlpatterns = [
    ...
    path('wasteplasticrequestor/latest/', views.FilterByLatestWastPlasticRequestorAPIView.as_view(), name='filter_by_latest'),
    path('wasteplasticrequestor/filterByRole/<int:requestor_id>/', views.FilterByRoleAndUserIdAPIView.as_view(), name='filter_by_role'),
